...
describe('textHighlighter with CSS Custom Highlight API', () => {
  ...
  describe('cross-element text matching', () => {
    ...
    it('highlights Regional Council of Occitania position text', () => {
      ...
      `;
      const result = highlightTextInScope(document, document.body, 'Member of the Regional Council of Occitania Incumbent Assumed office 2 July 2021');
      expect(result).toBeGreaterThan(0);
      expect(CSS.highlights.has('poliloom')).toBe(true);
    });
    ...
    it('highlights National Assembly position text', () => {
      ...
      `;
      const result = highlightTextInScope(document, document.body, 'Member of the National Assembly for Lot\'s 1st constituency Incumbent Assumed office 21 June 2017');
      expect(result).toBeGreaterThan(0);
      expect(CSS.highlights.has('poliloom')).toBe(true);
    });
    ...
    it('highlights General Secretary of The Republicans position text', () => {
      ...
      `;
      const result = highlightTextInScope(document, document.body, 'General Secretary of The Republicans In office 23 October 2019 – 18 January 2023');
      expect(result).toBeGreaterThan(0);
      expect(CSS.highlights.has('poliloom')).toBe(true);
    });
    ...
    it('highlights Mayor of Labastide-Murat position text', () => {
      ...
      `;
      const result = highlightTextInScope(document, document.body, 'Mayor of Labastide-Murat In office 2014–2018');
      expect(result).toBeGreaterThan(0);
      expect(CSS.highlights.has('poliloom')).toBe(true);
    });
    ...
    it('highlights 2008 cantonal elections text with references', () => {
      ...
      `;
      const result = highlightTextInScope(document, document.body, 'In the 2008 cantonal elections, Pradié was elected in the first round for the canton of Labastide-Murat, becoming the second-youngest councilor in France behind Jean Sarkozy');
      expect(result).toBeGreaterThan(0);
      expect(CSS.highlights.has('poliloom')).toBe(true);
    });
    ...
    it('highlights Cœur-de-Causse merger text with citation needed', () => {
      ...
      `;
      const result = highlightTextInScope(document, document.body, 'Following the merger of communities, he became mayor of Cœur-de-Causse (the new merged commune) in 2016.[citation needed]');
      expect(result).toBeGreaterThan(0);
      expect(CSS.highlights.has('poliloom')).toBe(true);
    });
    ...
    it('highlights municipal councilor text', () => {
      ...
      `;
      const result = highlightTextInScope(document, document.body, 'However, he remained a municipal and community councilor.');
      expect(result).toBeGreaterThan(0);
      expect(CSS.highlights.has('poliloom')).toBe(true);
    });
    ...
    it('highlights Shadow cabinet text with links', () => {
      ...
      `;
      const result = highlightTextInScope(document, document.body, 'In November 2018, Pradié joined the Shadow cabinet of Laurent Wauquiez, in charge of disability issues and solidarity.');
      expect(result).toBeGreaterThan(0);
      expect(CSS.highlights.has('poliloom')).toBe(true);
    });
    ...
    it('highlights Republicans convention committee text', () => {
      ...
      `;
      const result = highlightTextInScope(document, document.body, 'At the Republicans\' national convention in December 2021, Pradié was part of the 11-member committee which oversaw the party\'s selection of its candidate for the 2022 presidential elections.');
      expect(result).toBeGreaterThan(0);
      expect(CSS.highlights.has('poliloom')).toBe(true);
    });
  });
