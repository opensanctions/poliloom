...
def upgrade() -> None:
    ...
    op.drop_index(
        op.f("idx_wikidata_relations_composite"), table_name="wikidata_relations"
    )
    op.drop_index(
        op.f("idx_wikidata_relations_parent_entity_id"), table_name="wikidata_relations"
    )
    op.drop_index(
        op.f("idx_wikidata_relations_relation_type"), table_name="wikidata_relations"
    )
