...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_politicians_wikidata_id'), 'politicians', ['wikidata_id'], unique=True)
    ...
    op.create_index(op.f('ix_positions_wikidata_id'), 'positions', ['wikidata_id'], unique=True)
    ...
    op.create_table('holds_position',
    ...
    op.create_table('politician_source',
    sa.Column('politician_id', sa.String(), nullable=False),
    ...
    op.create_table('holdsposition_source',
    sa.Column('holdsposition_id', sa.String(), nullable=False),
    sa.Column('source_id', sa.String(), nullable=False),
    sa.ForeignKeyConstraint(['holdsposition_id'], ['holds_position.id'], ),
    sa.ForeignKeyConstraint(['source_id'], ['sources.id'], ),
    sa.PrimaryKeyConstraint('holdsposition_id', 'source_id')
    )
    op.create_table('property_source',
