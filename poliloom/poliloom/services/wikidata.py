...
class WikidataClient:
    ...
    def _parse_politician_data(self, entity: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if death_date:
            properties['DeathDate'] = death_date
        
        # Country of citizenship (P27)
        citizenship = self._extract_country_claim(claims.get('P27', []))
        country = citizenship[0] if citizenship else None
            ...
            if datavalue.get('type') == 'wikibase-entityid':
                ...
                if position_id:
                    ...
                    if position_name:
                        ...
                        start_date = self._extract_date_claim(qualifiers.get('P580', []))  # start time
                        end_date = self._extract_date_claim(qualifiers.get('P582', []))    # end time
    ...
    def _extract_wikipedia_links(self, sitelinks: Dict[str, Any]) -> List[Dict[str, str]]:
    ...
    def _get_entity_label(self, entity_id: str) -> Optional[str]:
        ...
        try:
            ...
            if 'entities' in data and entity_id in data['entities']:
                return data['entities'][entity_id].get('labels', {}).get('en', {}).get('value')
