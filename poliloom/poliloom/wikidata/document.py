...
def first_qualifier_time(document: dict, property_id: str) -> WikidataDate | None:
...
def format_timeframe(document: dict) -> str:
    ...
    """
    start = first_qualifier_time(document, _START_QUALIFIER_ID)
    end = first_qualifier_time(document, _END_QUALIFIER_ID)
